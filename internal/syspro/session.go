...
func (s *enetSession) SubmitOrder(ctx context.Context, order model.Order, lines []model.OrderLine) (*SalesOrderResult, error) {
	paramsXML, dataXML, err := buildSORTOI(order, lines, s.client.warehouse, s.client.allocationAction, s.client.taxCodeMap)
	if err != nil {
	...
	s.client.logger.Debug("submitting SORTOI",
		...
		"allocation_action", s.client.allocationAction,
	)
