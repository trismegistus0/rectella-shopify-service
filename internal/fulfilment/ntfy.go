...
// operator hears about a fulfilment write-back outage without it
// being a wake-up alarm. Runs in its own goroutine with a 5-second
// timeout so it never blocks the polling loop.
//
